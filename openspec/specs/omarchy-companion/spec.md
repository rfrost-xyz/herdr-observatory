# omarchy-companion Specification

## Purpose
Provide a read-only Omarchy bar overview and tiled companion window for current Herdr threads, Codex allowance, GPU activity and fleet health. Keep unavailable data explicit and make the local plugin installation reversible.
