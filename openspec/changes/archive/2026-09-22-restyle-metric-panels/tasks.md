## 1. Implementation
- [x] 1.1 Implement compact fleet panels, truthful bounded history and persistent state summary.
- [x] 1.2 Replace click inspector with hover/focus detail and bounded tile activation; remove redundant labels and activity.
...
- [x] 2.3 Synchronise specifications, archive evidence and publish the ready existing PR.
