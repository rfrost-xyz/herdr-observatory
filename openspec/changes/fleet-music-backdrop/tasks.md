...
- [ ] 2.2 Wire independent music endpoint and optional narrow Compose mount; verify disclosure and live source/receiver delivery.

## 3. Delivery
- [ ] 3.1 Update README and run all required checks, review independently and fix findings.
- [ ] 3.2 Deploy one reviewed image to both hosts, verify health and behaviour, retain rollback and remove task artefacts.
- [ ] 3.3 Record evidence, synchronise specs, archive and publish the ready PR.
