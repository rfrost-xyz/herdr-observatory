...
export function createEffect(text, name, palette) {
  ...
  const session=new Session(text,name,120,36,undefined,30,colours,palette.background.slice(1));
  ...
  return {
    next(){
      ...
      if(width!==120 || height!==36)throw new Error('Invalid effect dimensions');
